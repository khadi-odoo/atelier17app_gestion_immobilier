...
<div class="bg-light p-5 mb-5 text-center">
    <form action="" method="get" class="container d-flex gap-2">
        <input type="number" name="price" placeholder="Buget max" class="form-control" value=" {{ $input['price'] ?? '' }} ">
        <input type="number" name="surface" placeholder="Surface minimale" class="form-control" value=" {{ $input['surface'] ?? '' }} ">
        <input type="number" name="rooms" placeholder="Nombre de pieces minimum" class="form-control" value=" {{ $input['rooms'] ?? '' }} ">
